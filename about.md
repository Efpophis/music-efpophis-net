...
layout: page
title: About
subtitle: "The official web page for all of my AI-generated music projects"
---
...
You can see an example of the process [here](https://youtu.be/peraOQsuESQ?si=_YofF5wbj26nXZ6v).
...
The one that started it all. The intent here was to revive some of the songs from the Olden Days when I used to play in a real-live garage band called "Redeemer." You can see more about it on my <a href="https://blog.efpophis.net/p/the-redeemer-project.html" target=_blank>personal blog</a>.  The Redeemer Project's final album was [Seven](/albums/seven).

## Instrumental Works (Bill Crossley)

I've made a couple of experimental instrumantal / meditative compilations that are not Christian in nature. These can be found [here](/project/instrumental-projects), and are released with my own name as the "Artist."
