...
def render_album_md(
    ...
    year: str | None,
    cover_dest: str,
    embed_src_hint: str | None,
) -> str:
    year_line = f"year: {year}\n" if year else ""
    # embed_html is a YAML block; keep indentation consistent!
    embed_hint = embed_src_hint or "PASTE_EMBED_IFRAME_HERE"
    return f"""---
layout: album
...
## Tracklist
<!-- Link tracks after generation, or leave this section as-is and let your layout list tracks automatically if you build that later. -->
"""
...
def main():
    ...
    print(f"\nDone. Generated 1 album file + {created} track file(s).")
    print("Next steps:")
